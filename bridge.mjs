...
export class CodexBridge extends EventEmitter{
 ...
 async open(){
  ...
  try{await this.call('initialize',{clientInfo:{name:'ai_task_manager',title:'Ai Task Manager',version:'0.11.1'},capabilities:{experimentalApi:true}});this.send({method:'initialized'});this.connected=true;}catch(e){child.kill();throw e;}
 }
