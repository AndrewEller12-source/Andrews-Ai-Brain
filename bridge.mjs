...
export class CodexBridge extends EventEmitter{
 ...
 async open(){
  ...
  try{await this.call('initialize',{clientInfo:{name:'rewster_command',title:'Rewster Command',version:'0.2.0'},capabilities:{experimentalApi:true}});this.send({method:'initialized'});this.connected=true;}catch(e){child.kill();throw e;}
 }
